...
*/
export function sagaStackToString(sagaStack, crashedEffect) {
...
export function addSagaStack(runtimeInfo, errorStack) {
  if (typeof runtimeInfo.sagaStack === 'undefined') {
    runtimeInfo.sagaStack = []
  }

  runtimeInfo.sagaStack.push(errorStack)
}
